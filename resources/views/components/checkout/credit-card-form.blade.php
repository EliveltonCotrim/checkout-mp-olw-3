<form id="form-checkout" x-show="$wire.method == 1">
    <div class="py-4 grid grid-cols-6 gap-x-4 gap-y-6 sm:grid-cols-8">
        <div class="col-span-4 sm:col-span-8">
            ...
            <div class="mt-1">
                <div class="h-10 block w-full rounded-md text-primary-200 bg-tertiary-800 border-gray-300 shadow-sm focus:border-primary-200 focus:ring-primary-200 sm:text-sm"
                    id="form-checkout__cardNumber" type="text">
                </div>
            </div>
        </div>
        ...
        <div class="col-span-2 sm:col-span-4">
            ...
            <div class="mt-1">
                <div class="h-10 block w-full rounded-md text-primary-200 bg-tertiary-800 border-gray-300 shadow-sm focus:border-primary-200 focus:ring-primary-200 sm:text-sm"
                    type="text" id="form-checkout__expirationDate">
                </div>
            </div>
        </div>
        ...
        <div class="col-span-2 sm:col-span-4">
            ...
            <div class="mt-1">
                <div class="h-10 block w-full rounded-md text-primary-200 bg-tertiary-800 border-gray-300 shadow-sm focus:border-primary-200 focus:ring-primary-200 sm:text-sm"
                    type="text" id="form-checkout__securityCode">
                </div>
            </div>
        </div>
        ...
        <div class="col-span-4 sm:col-span-2">
            <x-input-label for="form-checkout__identificationType" value="Documento" />
            <div class="mt-1">
                <select
                    class="block w-full rounded-md text-primary-200 bg-tertiary-800 border-gray-300 shadow-sm focus:border-primary-200 focus:ring-primary-200 sm:text-sm"
